...
## 6. 按图片的标记顺序进行设置！--玩家角色蓝图接口设置

    1.在你的角色蓝图找到 类设置-> 细节面板，添加接口，选择Easy Hit Collision Interface.
    2.角色我的蓝图中，实现接口函数。
    3.将组件 Easy Hit Collision 返回给函数输出。

<img src="./IMG/6.png">

## 6. 按图片的标记顺序进行设置！--动画蒙太奇通知设置
